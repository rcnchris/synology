<?php
/** @var Rcnchris\Synology\Packages\AntiVirus\AntiVirus $package */
$package = $syno->AntiVirus;
?>
<div class="row">
    <div class="col-12">
        <hr/>
...
//        r($package->config('virusAction'));
        r($package->infos()->toArray());
        //r($package->infos('sysStatus'));
        r($package->scan()->toArray());
        ?>
    </div>
    <div class="col-6">
